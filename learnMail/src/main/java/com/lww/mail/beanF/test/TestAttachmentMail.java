 ...
 */
public class TestAttachmentMail {
    ...
    public static void main(String[] args) {
        ...
        Attachment attachment1 = new Attachment("C:\\freemarker\\file\\test1.docx");
        Attachment attachment2 = new Attachment("C:\\freemarker\\file\\test2.docx");
        ...
        mail.addBody(body)
                ...
                .addAttachmentList(attachmentList);
        try {
            mail.sendMail();
